// FIFA World Cup 2026 official Annex C: allocation of the eight best
// third-placed teams to the round-of-32 slots. There are 495 possible
// combinations of which groups' thirds qualify, and FIFA predefines exactly
// one matchup table per combination (the bracket can't be derived by a generic
// constraint solve — many permutations are valid, but only one is official).
//
// Key   = the eight qualifying group letters, sorted (e.g. "BDEFIJKL").
// Value = the third-place group for each winner slot, in this fixed order:
//         1A, 1B, 1D, 1E, 1G, 1I, 1K, 1L.
// So "BDEFIJKL" -> "EJBDIFLK" means 1A plays 3E, 1B plays 3J, 1D plays 3B, ...
//
// Parsed from Annexe C of the FIFA World Cup 2026 Regulations (May 2025).
export const THIRDS_SLOT_ORDER = ["1A", "1B", "1D", "1E", "1G", "1I", "1K", "1L"];

export const THIRDS_ALLOCATION = {
